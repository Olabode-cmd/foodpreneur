                                    ...
                                    <tbody>
                                        @foreach ($categories as $key => $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-primary btn-sm edit-course-category ml-3" data-categoryid="{{ $category->id }}">
                                                        Edit
                                                    </a>
                                                    <a href="{{ route('admin.coursesCategoryDestroy', $category->id) }}" class="btn btn-danger btn-sm delete-course-category" data-id="{{ $category->id }}">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
...
<div id="edit-course-category" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
           <form action="{{ route('admin.coursesCategoryStore') }}" method="POST" id="edit-course-category-form">
                @csrf
                @method('PATCH')
                <div class="modal-header">
