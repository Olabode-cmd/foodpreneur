@extends('layouts.app')
@section('title', 'Add Food Processing ')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row d-flex align-items-center">
                                <div class="col-6">
                                    <h4 class="card-title mb-4">Add Food Processing </h4>
                                </div>
                            </div>
                            @include('custom.alert')
                            <form class="row" action="{{ route('admin.processingStore') }}" method="post" enctype="multipart/form-data">
                                @csrf
